...
public class DefaultSQLDataHandler implements SQLDataHandler {
     ...
     *            instructs the data handler whether or not unknown or
     *            unrecognized SQL data types should simply be ignored */
     ...
     * @see prefuse.data.io.sql.SQLDataHandler#getDataType(java.lang.String,
     *      int) */
    @Override
