...
public class DataSourceWorker extends Thread {
    ...
    public static class Entry {
         ...
         *            the query to issue
         * @param keyField
         *            the key field that should be used to identify when
         *            duplicate results occur
         * @param lock
         *            an optional lock to synchronize on when processing data
         *            and adding it to the Table
         * @param listener
         *            an optional callback listener that allows notifications to
         *            be issued before and after query processing */
        public Entry(DatabaseDataSource ds, Table table, String query, String keyField,
         ...
         * occur. */
        String keyField;
        /** An optional lock to synchronize on when processing data and adding it
         * to the Table. */
        Object lock;
    }
