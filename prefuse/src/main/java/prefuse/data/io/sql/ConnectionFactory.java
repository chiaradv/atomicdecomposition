...
public class ConnectionFactory {
    ...
    public static DatabaseDataSource getDatabaseConnection(Connection conn,
            SQLDataHandler handler) throws SQLException {
     ...
     * 
     * @param driver
     *            the database driver to use, must resolve to a valid Java class
    ...
    public static DatabaseDataSource getDatabaseConnection(String driver, String url,
            String user, String password, SQLDataHandler handler) throws SQLException,
     ...
     * @throws ClassNotFoundException
     *             the class not found exception */
    public static DatabaseDataSource getMySQLConnection(String host, String database,
            String user, String password, SQLDataHandler handler) throws SQLException,
            ClassNotFoundException {
