...
public class Tree extends Graph {
     ...
     * @param targetKey
     *            data field used to denote the target node in an edge table */
    public Tree(Table nodes, Table edges, String nodeKey, String sourceKey,
            String targetKey) {
    ...
    public boolean isValidTree() {
        ...
        if (counts[0] < nedges) {
            s_logger.warning("Not all of the tree was visited. " + "Only " + counts[0]
                    + "/" + nedges + " edges encountered");
            return false;
        }
        return true;
    }
     ...
     * Tree instance, and returned. To clear out any generated spanning trees
     * use the clearSpanningTree() method of the Graph class. After calling
     * clearSpanningTree(), the getSpanningTree() method (with no arguments)
     * will return a pointer to this Tree instance instead of any generated
     * spanning trees.
     * 
     * @param root
