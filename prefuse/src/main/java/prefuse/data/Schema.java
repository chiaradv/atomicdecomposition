...
public class Schema implements Cloneable {
     ...
     *            {@link PrefuseLib#getEndField(String)}. The default behavior
     *            for these methods is to append ":start" to the name of a
     *            stating value column and append ":end" to the the name of an
     *            ending value column.
     *            </p> */
    ...
    public boolean equals(Object o) {
        ...
        for (int i = 0; i < m_size; ++i) {
            if (!(m_names[i].equals(s.getColumnName(i))
                    && m_types[i].equals(s.getColumnType(i)) && m_dflts[i].equals(s
                    .getDefault(i)))) {
                return false;
            }
        }
