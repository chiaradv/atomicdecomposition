...
public abstract class AbstractColumn implements Column {
    ...
    public void setParser(DataParser parser) {
        if (!m_columnType.isAssignableFrom(parser.getType())) {
            throw new IllegalArgumentException("Parser type ("
                    + parser.getType().getName() + ") incompatible with"
    ...
    public void setDefaultValue(Object dflt) {
        ...
        if (dflt != null
                && (!prim && !m_columnType.isInstance(dflt) || prim
                        && !TypeLib.isWrapperInstance(m_columnType, dflt))) {
            throw new IllegalArgumentException("Default value is not of type "
