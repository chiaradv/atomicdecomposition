...
public class Visualization {
    ...
    public static final String FOCUS_ITEMS = PrefuseConfig
            .get("visualization.focusItems");
    /** Default data group name for selected items. */
    public static final String SELECTED_ITEMS = PrefuseConfig
            .get("visualization.selectedItems");
    /** Default data group name for search result items. */
    public static final String SEARCH_ITEMS = PrefuseConfig
            .get("visualization.searchItems");
    // visual abstraction
    ...
    protected void checkGroupExists(String group) {
        if (m_visual.containsKey(group) || m_focus.containsKey(group)) {
            throw new IllegalArgumentException("Group name \'" + group
                    + "\' already in use");
        }
    }
    ...
    public synchronized VisualGraph addGraph(String group, Graph graph, Predicate filter,
        ...
        VisualGraph vg = new VisualGraph(nt, et, graph.isDirected(),
                graph.getNodeKeyField(), graph.getEdgeSourceField(),
    ...
    public synchronized VisualTable addDerivedTable(String group, String source,
     ...
     *         {@link #addDerivedTable(String, String, Predicate, Schema)}
     *         method, but with no VisualItem properties inherited from the
     *         source group. */
     ...
     * @return a filtered iterator over VisualItems
     *         {@link prefuse.data.expression.parser.ExpressionParser} class. If
     *         a parse error occurs, an empty iterator is returned. */
     ...
     *         {@link prefuse.activity.ActivityManager}, which runs in a
     *         dedicated thread. */
     ...
     * @param display
     *            the Display to add
     *            {@link prefuse.Display#setVisualization(Visualization)}
     *            method. */
