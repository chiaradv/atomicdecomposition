...
public class ActivityManager extends Thread {
     ...
     * Activity is cancelled, the second one will not run. This functionality is
     * provided by using an ActivityListener to monitor the first Activity. The
     * listener is removed upon completion or cancellation of the first
     * Activity. This method does not effect the scheduling of the first
     * Activity.
     * 
     * @param before
     ...
     * Activity is cancelled, the second one will not run. This functionality is
     * provided by using an ActivityListener to monitor the first Activity. The
     * listener will persist across mulitple runs, meaning the second Activity
     * will always be evoked upon a successful finish of the first. This method
     * does not otherwise effect the scheduling of the first Activity.
     * 
     * @param before
     *            the first Activity to run
     * @param after
    ...
    /** The Class ScheduleAfterActivity. */
    public class ScheduleAfterActivity extends ActivityAdapter {
        ...
        /** Instantiates a new schedule after activity.
         * 
         * @param after
         *            the after
         * @param remove
