...
public class MathLib {
     ...
     *         between 0 and 1. {@link prefuse.Constants#LINEAR_SCALE},
     *         {@link prefuse.Constants#LOG_SCALE},
     *         {@link prefuse.Constants#SQRT_SCALE}, or
     *         {@link prefuse.Constants#QUANTILE_SCALE}.
     *         {@link #quantiles(int, double[])} method. For any other scale
     *         type, the first value of the array must contain the minimum value
     *         of the distribution and the last value of the array must contain
     *         the maximum value of the distribution; all values in between will
     *         be ignored. */
