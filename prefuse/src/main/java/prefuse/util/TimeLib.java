...
public class TimeLib {
    ...
    private static final int[] CALENDAR_FIELDS = { Calendar.YEAR, Calendar.MONTH,
            Calendar.DATE, Calendar.HOUR_OF_DAY, Calendar.MINUTE, Calendar.SECOND,
     ...
     *         {@link java.util.Calendar#get(int)} method, but include support
     *         for the extended fields provided by this class (MILLENIUM,
     *         CENTURY, or DECADE). */
     ...
     * @return the cleared time {@link java.util.Calendar} fields, or one of the
     *         extended fields provided by this class (MILLENIUM, CENTURY, or
     *         DECADE). */
