...
public class JValueSlider extends JComponent {
    ...
    /** The m_slider. */
    protected final JSlider m_slider;
    /** The m_field. */
    protected final JTextField m_field;
    /** The m_listeners. */
    protected final List m_listeners;
    /** The m_smin. */
    ...
    private Number getSliderValue() {
        if (m_value instanceof Integer) {
            ...
            return m_value instanceof Double ? (Number) new Double(val) : new Float(
                    (float) val);
        }
    }
    ...
    private Number getFieldValue() {
        if (m_value instanceof Double || m_value instanceof Float) {
            ...
            return m_value instanceof Double ? (Number) new Double(v) : new Float(
                    (float) v);
        } else {
            long v;
            try {
