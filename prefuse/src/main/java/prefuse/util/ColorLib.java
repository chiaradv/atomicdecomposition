...
public class ColorLib {
    ...
    public static final float[] CATEGORY_HUES = { 0f, 1f / 12f, 1f / 6f, 1f / 3f,
            1f / 2f, 7f / 12f, 2f / 3f, /* 3f/4f, */5f / 6f, 11f / 12f };
    ...
    public static int[]
            getCategoryPalette(int size, float s1, float s2, float b, float a) {
        int[] cm = new int[size];
        float s = s1;
        for (int i = 0; i < size; i++) {
