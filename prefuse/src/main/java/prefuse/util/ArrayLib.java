...
public abstract class ArrayLib {
    ...
    public static final int
            binarySearch(Object[] a, Object key, Comparator cp, int length) {
        int x1 = 0;
        int x2 = length;
        int i = x2 / 2, c;
        while (x1 < x2) {
     ...
     * @param end
     *            the end index, exclusive, of the range to sort */
    public static final void sort(int[] a, Object[] b, int[] abuf, Object[] bbuf,
            int begin, int end) {
        int length = end - begin;
        if (length < SORT_THRESHOLD) {
            insertionsort(a, b, begin, end - 1);
     ...
     * @param off
     *            the off */
    protected static void mergesort(int ks[], int kd[], Object[] vs, Object[] vd, int lo,
            int hi, int off) {
        int length = hi - lo;
        if (length < SORT_THRESHOLD) {
    ...
    public static final void
            sort(Object[] a, int[] b, int begin, int end, Comparator cmp) {
