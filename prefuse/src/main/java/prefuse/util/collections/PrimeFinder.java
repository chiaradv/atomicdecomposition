...
public class PrimeFinder extends Object {
     ...
     * prime number <= desired capacity * 1.11 (11%). For any desired capacity
     * >= 200 the list includes a prime number <= desired capacity * 1.16 (16%).
     * For any desired capacity >= 16 the list includes a prime number <=
     * desired capacity * 1.21 (21%). Therefore, primes can be retrieved which
     * are quite close to any desired capacity, which in turn avoids wasting
    ...
    private static final int[] primeCapacities = {
            ...
            656429, 1312867, 2625761, 5251529, 10503061, 21006137,
            42012281,
            84024581,
            168049163,
            336098327,
     ...
     * 276172823,552345671,1104691373, //chunk #12 19,41,83,167,337,677,
     ...
     * //359339171,718678369,1437356741, //chunk #13
