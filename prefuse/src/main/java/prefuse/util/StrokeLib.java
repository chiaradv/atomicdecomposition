...
public class StrokeLib {
    ...
    public static BasicStroke getStroke(float width, float[] dashes) {
        return getStroke(width, BasicStroke.CAP_SQUARE, BasicStroke.JOIN_MITER, 10.0f,
                dashes, 0f);
    }
     ...
     * @return the stroke {@link java.awt.BasicStroke#CAP_BUTT},
     ...
     *         {@link java.awt.BasicStroke#JOIN_ROUND}
     * @see java.awt.BasicStroke */
    public static BasicStroke getStroke(float width, int cap, int join, float miterLimit,
    ...
    protected static int getStrokeKey(float width, int cap, int join, float miterLimit,
            float[] dashes, float dashPhase) {
    ...
    public static BasicStroke getDerivedStroke(BasicStroke s, float width) {
        if (s.getLineWidth() == width) {
            ...
            return getStroke(width * s.getLineWidth(), s.getEndCap(), s.getLineJoin(),
