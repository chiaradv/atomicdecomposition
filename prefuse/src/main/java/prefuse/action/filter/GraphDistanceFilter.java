...
public class GraphDistanceFilter extends GroupAction {
     ...
     *            is run. {@link prefuse.Visualization#FOCUS_ITEMS} group will
     *            be used as the source nodes from which to measure the
     *            distance. */
     ...
     *            {@link prefuse.Visualization#FOCUS_ITEMS} group will be used
     *            as the source nodes from which to measure the distance. */
