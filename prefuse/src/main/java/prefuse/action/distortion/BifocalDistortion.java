 ...
 * href="portal.acm.org/citation.cfm?id=180173&dl=ACM"> acm/id=180173</a>.
 * </p>
 * 
...
public class BifocalDistortion extends Distortion {
    ...
    @Override
    protected double distortSize(Rectangle2D bbox, double x, double y, Point2D anchor,
            Rectangle2D bounds) {
     ...
     *            the max
     * @return the double */
    private double bifocal(double x, double a, double r, double mag, double min,
            double max) {
