...
public class LabelRenderer extends AbstractShapeRenderer {
    ...
    protected Shape getRawShape(VisualItem item) {
        ...
        switch (m_imagePos) {
            ...
            case Constants.RIGHT:
                w = tw
                        + size
                        * (iw + 2 * m_horizBorder + (tw > 0 && iw > 0 ? m_imageMargin : 0));
            ...
            case Constants.BOTTOM:
                ...
                h = th
                        + size
                        * (ih + 2 * m_vertBorder + (th > 0 && ih > 0 ? m_imageMargin : 0));
                break;
            default:
        ...
        if (m_bbox instanceof RoundRectangle2D) {
            ...
            rr.setRoundRect(m_pt.getX(), m_pt.getY(), w, h, size * m_arcWidth, size
                    * m_arcHeight);
        } else {
    ...
    public void render(Graphics2D g, VisualItem item) {
        ...
        double size = item.getSize();
        boolean useInt = 1.5 > Math.max(g.getTransform().getScaleX(), g.getTransform()
                .getScaleY());
     ...
     * 
     * @return the horizontal text alignment {@link prefuse.Constants#LEFT},
     ...
     *            {@link prefuse.Constants#RIGHT}, or
     *            {@link prefuse.Constants#CENTER}. The default is centered
     *            text. */
     ...
     * 
     * @return the vertical text alignment {@link prefuse.Constants#TOP},
     ...
     * 
     * @return the horizontal image alignment {@link prefuse.Constants#LEFT},
     *         {@link prefuse.Constants#RIGHT}, or
     *         {@link prefuse.Constants#CENTER}. The default is a centered
     *         image. */
     ...
     * 
     * @return the vertical image alignment {@link prefuse.Constants#TOP},
     *         {@link prefuse.Constants#BOTTOM}, or
     *         {@link prefuse.Constants#CENTER}. The default is a centered
     *         image. */
     ...
     * 
     * @return the image position {@link Constants#RIGHT}, {@link Constants#TOP}
     *         , or {@link Constants#BOTTOM}. The default is left. */
     ...
     * 
     * @param pos
     *            the desired image position {@link Constants#RIGHT},
     *            {@link Constants#TOP}, or {@link Constants#BOTTOM}. The
     *            default is left. */
