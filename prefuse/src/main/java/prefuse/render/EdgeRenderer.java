...
public class EdgeRenderer extends AbstractShapeRenderer {
    ...
    protected Shape getRawShape(VisualItem item) {
        ...
        if (e.isDirected() && m_edgeArrow != Constants.EDGE_ARROW_NONE) {
            ...
            int i = GraphicsLib.intersectLineRectangle(start, end, dest.getBounds(),
                    m_isctPoints);
            if (i > 0) {
                end = m_isctPoints[0];
            }
        ...
        switch (type) {
            ...
            case Constants.EDGE_TYPE_CURVE:
                ...
                m_cubic.setCurve(n1x, n1y, m_ctrlPoints[0].getX(),
                        m_ctrlPoints[0].getY(), m_ctrlPoints[1].getX(),
     ...
     * @return the desired line width, in pixels {@link VisualItem#getSize()}.
     *         Subclasses can override this method to perform custom line width
     *         determination, however, the preferred method is to change the
     *         item size value itself. */
    ...
    protected void getCurveControlPoints(EdgeItem eitem, Point2D[] cp, double x1,
    ...
    protected static void
            getAlignedPoint(Point2D p, Rectangle2D r, int xAlign, int yAlign) {
     ...
     * 
     * @return the edge type {@link prefuse.Constants#EDGE_TYPE_LINE} or
     *         {@link prefuse.Constants#EDGE_TYPE_CURVE}. */
     ...
     * 
     * @param type
     *            the new edge type {@link prefuse.Constants#EDGE_TYPE_LINE} or
     *            {@link prefuse.Constants#EDGE_TYPE_CURVE}. */
    ...
    /** Returns the type of the drawn edge. This is one of
     * 
     * @return the edge type {@link prefuse.Constants#EDGE_ARROW_FORWARD},
     *         {@link prefuse.Constants#EDGE_ARROW_REVERSE}, or
     *         {@link prefuse.Constants#EDGE_ARROW_NONE}. */
     ...
     * 
     * @param type
     *            the new arrow type {@link prefuse.Constants#EDGE_ARROW_NONE}
     *            for no edge arrows,
     *            {@link prefuse.Constants#EDGE_ARROW_FORWARD} for arrows from
     *            source to target on directed edges, or
     *            {@link prefuse.Constants#EDGE_ARROW_REVERSE} for arrows from
     *            target to source on directed edges. */
