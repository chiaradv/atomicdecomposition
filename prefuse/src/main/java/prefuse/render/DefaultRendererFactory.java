...
public class DefaultRendererFactory implements RendererFactory {
     ...
     *            {@link #getRenderer(VisualItem)} whenever there are no
     *            matching predicates and the input item <em>is not</em> an
     *            EdgeItem. To set the default renderer for EdgeItems, see
     ...
     *            {@link #getRenderer(VisualItem)} whenever there are no
     *            matching predicates and the input item <em>is</em> an
     *            EdgeItem. To set the default renderer for non-EdgeItems, see
     ...
     *            {@link #getRenderer(VisualItem)} matches the predicate, then
     *            the corresponding Renderer will be returned. Predicates are
     *            evaluated in the order in which they are added, so if an item
     *            matches multiple predicates, the Renderer for the earliest
