...
public class AtomicDecomposerDepedenciesTest {
	...
	public static void atomicDecomposerDepedenciesTest()
		...
		OWLSubClassOfAxiom poweryogaSub = f.getOWLSubClassOfAxiom(powerYoga,
				yoga);
		OWLSubClassOfAxiom yogaSubRelax = f.getOWLSubClassOfAxiom(yoga,
				relaxation);
		OWLSubClassOfAxiom relaxSubActivity = f.getOWLSubClassOfAxiom(
				relaxation, activity);
